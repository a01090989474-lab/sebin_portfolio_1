...
const works = [
  {
    title: "PHYSIS",
    description:
      "PHYSIS 기업의 브랜드 아이덴티티를 온라인에서 효과적으로 전달하기 위한 기업 홈페이지 제작 프로젝트입니다. 기획, 디자인, 프론트엔드 구현까지 전 과정을 단독으로 진행하여 완성했습니다.",
    period: "2026.05.20 - ",
    part: "Plan 100%  Design 100%  Coding 100%",
    tools: [
    ...
    siteUrl: "https://physis-phi.vercel.app/",
    image: "/images/physis.png",
    imageLeft: true,
  },
  {
    ...
    <section className="works" ref={containerRef}>
      ...
      <div className="works__list">
        {works.map((work, i) => (
          <div
            key={i}
            className={`works__item fade-in${work.imageLeft ? " works__item--image-left" : ""}`}
          >
            ...
            <div className="works__content">
              ...
              <div className="works__images">
                <img src={work.image} alt={work.title} className="works__img" />
              </div>
            </div>
          </div>
        ))}
